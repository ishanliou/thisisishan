...
const ProjectSingle = ({
  ...
  return (
    <section className={`${name}-project mt-28 project`} ref={setProjectsRef}>
      <div
        className={`"project-container relative ${backgroundWidth} w-full h-full mx-auto p-4 flex justify-center items-center bg-${backgroundColor} rounded-${borderRadiusRight} reveal rounded-${borderRadiusLeft} "`}
      >
